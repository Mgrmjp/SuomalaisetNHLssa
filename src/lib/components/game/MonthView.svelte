...
<div class="calendar-month bg-white rounded-xl shadow-md p-3 border border-gray-100">
    <div class="calendar-month__header flex items-center justify-between mb-3">
        <button
            class="calendar-month__nav-btn calendar-month__nav-btn--prev p-1 rounded bg-finnish-blue-500 text-white hover:bg-finnish-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 text-xs"
        ...
        <h2 class="calendar-month__title text-base font-bold text-gray-900">
            {_getMonthYearDisplay()}
        </h2>
        <button
            class="calendar-month__nav-btn calendar-month__nav-btn--next p-1 rounded bg-finnish-blue-500 text-white hover:bg-finnish-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 text-xs"
    ...
    <div class="calendar-month__body space-y-1">
        <div
            class="calendar-month__grid-labels grid grid-cols-7 gap-0.5 text-center text-[10px] font-bold text-gray-500 mb-1 uppercase tracking-wider"
        >
            <div>Ma</div>
            <div>Ti</div>
            <div>Ke</div>
        ...
        <div class="calendar-month__grid-days grid grid-cols-7 gap-0.5">
    ...
    <div class="calendar-month__legend mt-3 pt-2 border-t border-gray-100">
        <div
            class="calendar-month__legend-item flex items-center space-x-2 text-[10px] text-gray-500"
        >
            <div
                class="calendar-month__legend-dot w-1.5 h-1.5 rounded-full bg-finnish-blue-400"
            ></div>
