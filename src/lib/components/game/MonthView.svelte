...
>
    ...
    <div class="calendar-month__body space-y-2 min-h-[300px]">
            ...
            <div class="calendar-month__grid-days grid grid-cols-7 gap-1 sm:gap-2">
                {#each calendarDays as day}
                    ...
                    >
                        ...
                        {#if day.hasData}
                            <div
                                class="calendar-month__day-dot w-1 h-1 rounded-full mt-1"
        ...
        {:else}
            <div
                class="calendar-month__years grid grid-cols-3 gap-3 animate-in fade-in zoom-in-95 duration-200"
            >
                {#each years as year}
                    <button
                        ...
                        class:text-gray-700={year !== currentMonth.getFullYear()}
