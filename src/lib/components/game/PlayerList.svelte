	...
	<section id="scoringList" class="py-8">
		...
		{#if !hasAnyPlayers && $isLoading === false}
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
				<div class="col-span-2 md:col-span-2 lg:col-span-2 lg:col-start-2 xl:col-span-2 xl:col-start-2 bg-white rounded-lg shadow-lg p-6 relative overflow-hidden min-h-[220px] flex items-center justify-center"
					...
					<div class="relative z-10 text-center">
						<div class="w-16 h-16 bg-finnish-blue-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
							<svg viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8">
								<path d="M12 14.5C13.1046 14.5 14 13.6046 14 12.5C14 11.3954 13.1046 10.5 12 10.5C10.8954 10.5 10 11.3954 10 12.5C10 13.6046 10.8954 14.5 12 14.5Z" stroke="#1e40af" stroke-miterlimit="10" fill="none"></path>
								<path d="M19.5 14.5C20.6046 14.5 21.5 13.6046 21.5 12.5C21.5 11.3954 20.6046 10.5 19.5 10.5C18.3954 10.5 17.5 11.3954 17.5 12.5C17.5 13.6046 18.3954 14.5 19.5 14.5Z" stroke="#1e40af" stroke-miterlimit="10" fill="none"></path>
								<path d="M4.5 14.5C5.60457 14.5 6.5 13.6046 6.5 12.5C6.5 11.3954 5.60457 10.5 4.5 10.5C3.39543 10.5 2.5 11.3954 2.5 12.5C2.5 13.6046 3.39543 14.5 4.5 14.5Z" stroke="#1e40af" stroke-miterlimit="10" fill="none"></path>
							</svg>
						</div>
