...
<div class="finnish-roster">
	...
	{:else}
		<div class="roster-header mb-8">
			...
			<p class="text-gray-600">Yhteensä {_players.length} suomalaista pelaajaa NHL:ssä (pelaamattomat ja loukkaantuneet eivät mukana)</p>
		</div>
				...
				<div class="team-card" style:--team-primary-color="#1e40af">
					...
					<div class="team-header">
						<div class="team-logo-wrapper">
							<TeamLogo team={teamAbbr} size="lg" />
						</div>
						<div class="team-info">
							<h3 class="team-name">{teamName}</h3>
							<p class="player-count">{teamPlayers.length} pelaaj{teamPlayers.length === 1 ? 'a' : 'aa'}</p>
						</div>
					</div>
