...
>
    ...
    <td class="px-3 py-3 text-sm font-medium text-gray-900 text-center w-12">
        <div class="flex items-center justify-center">
            ...
            {#if showPlayoffIndicator && isPlayoffTeam}
                <div
                    class="ml-1 w-2 h-2 bg-gray-800 rounded-full"
    ...
    <!-- Wins -->
    <td class="px-3 py-3 text-sm text-center w-12">
        {teamStats.wins}
    </td>
    ...
    <!-- Points -->
    <td class="px-3 py-3 text-sm font-bold text-center w-12">
        {teamStats.points}
    </td>
    ...
    <!-- Last 10 Games -->
    <td class="px-3 py-3 text-sm text-center text-gray-600 w-20">
    ...
    {#if showAdvancedStats}
        ...
        <!-- Goal Differential -->
        <td class="px-3 py-3 text-sm text-center w-14">
            <span class={advancedStats.goalDifferential > 0 ? 'text-green-700' : advancedStats.goalDifferential < 0 ? 'text-red-700' : 'text-gray-700'}>
