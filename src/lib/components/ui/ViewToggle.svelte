    ...
    <div class="inline-flex rounded-lg border border-gray-200 bg-gray-100 p-1 gap-x-1" role="group">
        ...
        <button
            ...
            class="{playersActive
                ...
                : 'text-gray-700 hover:bg-white hover:text-gray-900 cursor-pointer'} relative inline-flex items-center rounded-md px-4 py-2 text-sm font-medium transition-colors duration-200 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            onclick={() => _handleViewChange("players")}
        ...
        >
            ...
            >
                <path
                    d="M7.6,3,5.1,4.6l4,6.3,1.8-2.8L7.6,3m8.8,0L7.5,17H2v4H8.5L19,4.6,16.4,3M15,14.6l-1.8,2.8L15.5,21H22V17H16.5Z"
                />
            </svg>
            Tulokset
        </button>
        ...
        <button
            ...
            class="{standingsActive
                ? 'bg-white text-gray-900 shadow-sm cursor-pointer'
                : 'text-gray-700 hover:bg-white hover:text-gray-900 cursor-pointer'} relative inline-flex items-center rounded-md px-4 py-2 text-sm font-medium transition-colors duration-200 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            onclick={() => _handleViewChange("standings")}
        ...
        <button
            ...
            class="{rosterActive
                ? 'bg-white text-gray-900 shadow-sm cursor-pointer'
                : 'text-gray-700 hover:bg-white hover:text-gray-900 cursor-pointer'} relative inline-flex items-center rounded-md px-4 py-2 text-sm font-medium transition-colors duration-200 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            onclick={() => _handleViewChange("roster")}
