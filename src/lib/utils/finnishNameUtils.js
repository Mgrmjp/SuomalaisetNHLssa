...
const defaultCorrections = {
    ...
    Haanpaa: 'Haanpää',
    Kyllonen: 'Kyllönen',
    Maenalanen: 'Mäenalanen',
    Keranen: 'Keränen',
    Gronstrand: 'Grönstrand',
    Siren: 'Sirén',
    Melametsa: 'Melametsä',
    Niittymaki: 'Niittymäki',
    Tormanen: 'Törmänen',
    Pihlstrom: 'Pihlström',
    Ylonen: 'Ylönen',
    Pitkanen: 'Pitkänen',
    Lehtera: 'Lehterä',
    Kekalainen: 'Kekäläinen',
    Marjamaki: 'Marjamäki',
    Pyorala: 'Pyörälä',
    Makela: 'Mäkelä',
    Backstrom: 'Bäckström',
    Hakanpaa: 'Hakanpää',
    Nattinen: 'Nättinen',
    Bjorkqvist: 'Björkqvist',
    Gronman: 'Grönman',
    Seppa: 'Seppä',
    Rynnas: 'Rynnäs',
    Maki: 'Mäki',
    Salomaki: 'Salomäki',
    Hannikainen: 'Hännikäinen',
    Vehvilainen: 'Vehviläinen',
    Lepisto: 'Lepistö',
    Sateri: 'Säteri',
    Ramo: 'Rämö',
    Jarventie: 'Järventie',
