...
function generateFallbackAvatar(playerName: string, team: string): string {
        ...
        const teamColors: Record<string, string> = {
                'ANA': 'B8860B', 'ARI': 'E85D04', 'BOS': 'FFB81C', 'BUF': '007A50',
                'CGY': 'C8102E', 'CAR': 'CC0000', 'CHI': 'CF0A2C', 'COL': '6F002F',
                'CBJ': '041E42', 'DAL': '006847', 'DET': 'C8102E', 'EDM': 'FF4C00',
                'FLA': 'C8102E', 'LAK': '852C2C', 'MIN': '154734', 'MTL': 'AF1E32',
                'NJD': 'CE1126', 'NSH': 'FFB81C', 'NYI': 'F47920', 'NYR': '003E7E',
                'OTT': 'C8102E', 'PHI': 'FF6A00', 'PIT': 'FFB81C', 'SJS': '00627C',
                'SEA': '96D822', 'STL': '002F5F', 'TBL': '002868', 'TOR': '003E7E',
                'VAN': '041C42', 'VGK': 'B9975B', 'WPG': '041C42', 'WSH': 'C8102E'
        }
