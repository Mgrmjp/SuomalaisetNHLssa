			...
			<div class="flex flex-wrap justify-center gap-8 hero-stats">
				<div class="text-center hero-stat hero-stat--goals">
					<div class="flex justify-center mb-1 hero-stat__icon-wrap">
						<svg class="text-gray-600 hero-stat__icon hero-stat__icon--goals" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
					...
					<div class="text-xs text-gray-600 hero-stat__label" data-full="Maalit (Goals)">Maalit</div>
				</div>
				<div class="text-center hero-stat hero-stat--assists">
					<div class="flex justify-center mb-1 hero-stat__icon-wrap">
						<svg class="text-gray-600 hero-stat__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
					...
					<div class="text-xs text-gray-600 hero-stat__label" data-full="Syötöt (Assists)">Syötöt</div>
				</div>
				<div class="text-center hero-stat hero-stat--points">
					<div class="flex justify-center mb-1 hero-stat__icon-wrap">
						<svg class="text-gray-600 hero-stat__icon hero-stat__icon--points" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					...
					<div class="text-xs text-gray-600 hero-stat__label" data-full="Pisteet (Points)">Pisteet</div>
				</div>
				<div class="text-center hero-stat hero-stat--pims">
					<div class="flex justify-center mb-1 hero-stat__icon-wrap">
						<svg class="text-gray-600 hero-stat__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
					...
					<div class="text-xs text-gray-600 hero-stat__label" data-full="Rangaistusmin (PIM)">Rangaistusmin</div>
				</div>
